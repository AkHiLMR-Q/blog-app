...
exports.addProject=async(req,res)=>{
    ...
    console.log(title,overview,projectImage);
    console.log(userId);
    ...
    try {
        ...
        if(existingProject){
            ...
            const newProjects=new projects({title,overview,projectImage,userId})
...
exports.updateUserProjects=async(req,res)=>{
    const{title,overview,projectImage}=req.body
    userId=req.payload
    ...
    try {
        ...
        const updateProject=await projects.findByIdAndUpdate({_id:pid},{title,overview,projectImage:uploadImage,userId}) 
